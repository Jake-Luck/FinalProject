...
\usepackage{amsfonts}
\makeatletter
\xpatchcmd{\@todo}{\setkeys{todonotes}{#1}}{\setkeys{todonotes}{inline,#1}}{}{} % Set inline as default for todos
\makeatother
...
\begin{document}
    ...
    \todo{Paragraph describing different types of algorithm used (Routing, Cluster and Routing, Evolutionary,
        etc.)}
