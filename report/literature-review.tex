...
large contributions across a wide range of mathematics. \todo{cite tsp: a computational study, pg 40--41}
The TSP can be described simply as: Given a set of locations and the cost of travel between them, find the shortest
route that visits each location and returns to the start\todo{cite tsp: a computational study, pg 1}.\\
...
our problem.
The TSP is proven to be NP-hard\todo{cite introduction to algorithms, pg 1096--1097}, meaning that there are no
...
NP-hard.
\todo{Discuss how knowledge of NP-hardness can be used to decide which algorithms to investigate.}

\todo{Discuss a couple of solutions/types of solution}

\todo{sentence about TSP variants, leads into paragraph about mTSP}
