...
\begin{figure}[H]
    \centering
    \includegraphics{Routing.greedy_insertion}
...
\begin{figure}
    \centering
    \includegraphics{GreedyInsertion_Birmingham_Example}
