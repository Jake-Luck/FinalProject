...
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{Centroid_Crossover_Example}
...
\begin{figure}
    ...
    \caption{Code from GeneticCentroidClustering.find_clusters in algorithms\textbackslash clustering.py}
